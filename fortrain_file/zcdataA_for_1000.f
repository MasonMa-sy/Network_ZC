...
!c Declare the variables related to ZC model.
      ...
      integer i,j,k,ipertur,jpertur,i1,i2,irec

      real*8 tinitial,tfinal, f_max
...
c      call CPU_TIME(timeMid)
      open(unit=376,file='data_13000.dat',
...
200     format(34(1x,f12.5))
	    ...
	    do tinitial=61,1061,1.0d0
        tfinal=tinitial+1.0d0
        write(filename,'(i5.5)') int(tinitial-61+13000)
...
c        close(375)
        ssta = ssta_end
        h1a = h1a_end
        print *,tinitial-61+13000,' has been done.'
      end do
c---test msst
