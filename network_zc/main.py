...
from network_zc.model_trainer import dense_trainer_sstaha_2
...
# Load the model
model_name = dense_trainer_sstaha_2.model_name
...
predict_data[0] = file_helper.read_data_sstaha_separate(file_num, 1)
data_x[0] = np.reshape(predict_data[0], (1, 1080))
file_helper.write_data(file_num, model.predict(data_x)[0])
